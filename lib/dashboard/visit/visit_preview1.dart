...
class VisitPreviewScreen1 extends StatefulWidget {
  @override
  _VisitPreviewScreen1State createState() => _VisitPreviewScreen1State();
}

class _VisitPreviewScreen1State extends State<VisitPreviewScreen1> {
